    ...
    <div>
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <img src={course.course_title_img} alt={course.course_title} />
        </div>
        <div className={styles.details}>
          <div className={styles.organization}>
            <p>Organization: {course.course_organization}</p>
            <img
              src={course.course_organization_img}
              alt={course.course_organization}
            />
          </div>
          ...
          <div className={styles.students}>
            ...
            <p>{course.course_students_enrolled}</p>
          </div>
          <button
            ...
            disabled={loading}
          >
            {loading ? "Processing..." : "Buy with MetaMask"}
          </button>
